...
public class DataSeeder {
    ...
    public static void seedRestaurants() {
        ...
        Restaurant burgerPalace = new Restaurant("R001", "Burger Palace", "Main Boulevard, Gulberg, Lahore", "American",
        ...
        for (Restaurant r : loaded) {
            ...
            System.out.println(
                    "Rating  : " + String.format("%.1f", r.getRating()) + " (" + r.getTotalRatings() + " ratings)");
