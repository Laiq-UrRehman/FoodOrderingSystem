...
public class CustomerSeeder {
    ...
    public static void seedCustomers() {
        ...
        try {
            ...
            System.out.println("[CustomerSeeder] Failed to save customers: " + e.getMessage());
            return;
        }
        ...
        try {
            loaded = fileHandler.loadArray("customers.dat");
        } catch (FileHandler.FileOperationException e) {
            System.out.println("[CustomerSeeder] Failed to load customers: " + e.getMessage());
            return;
        }
